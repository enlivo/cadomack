...
export default function Home() {
  ...
  return (
    <div className="bg-white">
      {/* Hero Section */}
      <section
        className="relative min-h-[85vh] flex items-center overflow-hidden bg-no-repeat"
        style={{
      ...
      >
        {/* Overlay */}
        <div className="absolute inset-0 bg-gradient-to-r from-blue-950/65 via-blue-900/45 to-emerald-900/35"></div>
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10 py-24">
          <div className="grid gap-12 lg:grid-cols-[1.1fr_0.9fr] items-center">
            ...
            <div className="max-w-2xl">
              <span className="inline-block py-2 px-4 rounded-full bg-emerald-500/20 text-emerald-200 border border-emerald-400/30 font-semibold text-sm mb-6 tracking-wider backdrop-blur-sm">
              ...
              <p className="text-lg md:text-xl text-slate-100 mb-10 max-w-2xl leading-relaxed">
                Cadomack Pharmaceuticals builds powerful therapeutic solutions
                across diabetes, cardiovascular, nutrition and wellness with
                world-class manufacturing, safety and customer support.
              </p>

              <div className="flex flex-col sm:flex-row gap-4">
                <Link
                  to="/products#product-view"
                  className="inline-flex items-center justify-center gap-2 bg-gradient-to-r from-emerald-500 to-teal-600 text-white px-8 py-4 rounded-full font-bold text-lg transition-all duration-300 hover:shadow-lg hover:shadow-emerald-500/40 hover:scale-105"
                >
                ...
                <Link
                  to="/about"
                  className="inline-flex items-center justify-center bg-white/10 backdrop-blur-sm text-white border border-white/20 px-8 py-4 rounded-full font-bold text-lg transition-all duration-300 hover:bg-white/20"
                >
                  About Cadomack
                </Link>
              </div>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-slate-600 max-w-2xl mx-auto">
              We develop targeted pharmaceutical solutions across key healthcare
              areas.
            </p>
          </div>
            ...
            {therapeuticSegments.map((item) => (
              ...
              >
                ...
                <p className="text-sm text-slate-500">
                  View our {item.title.toLowerCase()} portfolio.
                </p>
              </Link>
            ))}
          </div>
      ...
      <section className="py-20 bg-slate-50">
        <div className="container mx-auto px-4 md:px-6">
          <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between mb-12">
            <div className="max-w-2xl">
              <p className="text-emerald-600 font-semibold uppercase tracking-[0.3em] mb-2">
                Explore Categories
              </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-6">
            {categories.map((item) => {
              ...
              return (
                <div
                  key={item.title}
                  className="rounded-[2rem] bg-white p-8 border border-slate-200 shadow-sm hover:shadow-xl transition-all duration-300"
                >
                  ...
                  <p className="text-sm text-slate-400">
                    Trusted solutions for clinics, pharmacies and hospitals.
                  </p>
                </div>
              );
            })}
          ...
          <div className="grid gap-8 lg:grid-cols-2 items-center">
            <div className="space-y-6">
              ...
              <p className="text-lg text-slate-600 max-w-xl leading-relaxed">
                We deliver safety-backed formulations through GMP-certified
                processes, 24/7 customer support, and a dependable supply chain
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              {categories.map((item) => {
                ...
                return (
                  <div
                    key={item.title}
                    className="rounded-3xl bg-white p-6 shadow-lg border border-slate-100"
                  >
      ...
      <section className="py-20 bg-slate-100">
        <div className="container mx-auto px-4 md:px-6 text-center">
          ...
          <p className="text-slate-600 mb-10 max-w-2xl mx-auto">
            Our products are manufactured under strict regulatory standards
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center max-w-3xl mx-auto mb-10">
            <h4 className="text-emerald-600 font-bold tracking-wider uppercase mb-2">
              Deal Hot of the Month
            </h4>

            <h2 className="text-3xl md:text-5xl font-extrabold text-blue-950 mb-4">
              Featured Medicines and Care Packages
            </h2>

            <p className="text-slate-600 text-lg">
              Explore our most trusted products, carefully curated for better
          ...
          <div className="grid gap-6 lg:grid-cols-3">
            {featuredProducts.map((product) => (
              <div
                key={product.id}
                className="group rounded-[2rem] overflow-hidden border border-slate-200 shadow-lg transition-all hover:-translate-y-1 hover:shadow-2xl"
              >
                <div className="relative h-72 overflow-hidden bg-slate-100">
                  ...
                  <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-slate-950/80 to-transparent p-4">
                    <p className="text-sm text-emerald-300 uppercase tracking-[0.2em]">
                      Hot Pick
                    </p>
                  </div>
                </div>
      ...
      <section className="py-20 bg-gradient-to-r from-emerald-600 to-teal-600">
        <div className="container mx-auto px-4 md:px-6 text-center">
          ...
          <p className="text-lg text-emerald-50 mb-10 max-w-2xl mx-auto">
            Contact us for business inquiries, distribution opportunities, or
            product information.
          </p>
